...
<html>
    ...
    <body class="bg-light">
        ...
        <main>
            <section class="py-5">
                <div class="container">
                    <h1 class="text-center display-4 mb-5"> Cadastrar </h1>

                    <div class="text-center text-md-left mb-5">
                        <a class="btn btn-outline-primary" href="index.php"> Voltar ao Menu </a>
                    </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-6 col-md-3">
                            <a href="cadastrar/hotel.php">
                                <div class="bloco rounded-lg py-5 shadow">
                                    <img src="_img/icones/cadastrar-hotel.png" alt="">
                                    <p> Hotel </p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-6 col-md-3">
                            <a href="cadastrar/quarto.php">
                                <div class="bloco rounded-lg py-5 shadow">
                                    <img src="_img/icones/cadastrar-quarto.png" alt="">
                                    <p> Quarto </p>
                                </div>
                            </a>
                        </div>
