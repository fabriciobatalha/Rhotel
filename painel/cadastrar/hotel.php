...
<html>
    ...
    <body class="bg-light">
        ...
        <main>
            <section class="py-5">
                <div class="container">
                    <h1 class="text-center display-4 mb-5"> Cadastrar Hotel </h1>
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-12 col-md-6">
                            <form action="../_rotinas/cadastrar/hotel.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="localizacao" name="localizacao" maxlength="30" required>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="sobre" name="sobre" maxlength="250" required>
                                </div>
                                ...
                                <div class="row px-4 mb-3">
                                    <div class="form-check col-6">
                                        <input class="form-check-input" type="checkbox" value="Wi-Fi" id="wifi" name="comodidades[1]">
                                        <label class="form-check-label" for="wifi"> Wi-Fi </label>
                                    </div>
    
                                    <div class="form-check col-6">
                                        <input class="form-check-input" type="checkbox" value="Estacionamento" id="estacionamento" name="comodidades[2]">
                                        <label class="form-check-label" for="estacionamento"> Estacionamento </label>
                                    </div>

                                    <div class="form-check col-6">
                                        <input class="form-check-input" type="checkbox" value="Piscina" id="piscina" name="comodidades[3]">
                                        <label class="form-check-label" for="piscina"> Piscina </label>
                                    </div>

                                    <div class="form-check col-6">
                                        <input class="form-check-input" type="checkbox" value="Café Incluso" id="cafe" name="comodidades[4]">
                                        <label class="form-check-label" for="cafe"> Café Incluso </label>
                                    </div>
                                </div>
